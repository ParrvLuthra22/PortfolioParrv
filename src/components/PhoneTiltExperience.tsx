...
const APP_PROJECTS: AppProject[] = [
  {
    id: 'upsosh-mobile',
    name: 'upSosh',
    tagline: 'Discover micro-events',
    platform: 'both',
    gradient: ['#0a1628', '#0d1f3c', '#112952'],
    accentColor: '#60A5FA',
    uiElements: ['Event Feed', 'Book Now', 'My Tickets', 'Explore'],
    github: '',
    demo: '',
    tech: ['React Native', 'Node.js', 'PostgreSQL', 'DodoPayments'],
    highlights: [
      'Real-time event discovery feed with location filtering',
      'One-tap booking with DodoPayments secure checkout',
      'QR-code ticket system with offline support',
    ],
    screenGradient: 'linear-gradient(160deg, #0a1628 0%, #112952 50%, #60A5FA 100%)',
  },
  {
    id: 'tunemate',
    name: 'TuneMate',
  ...
  },
  {
    ...
    platform: 'both',
    gradient: ['#1a0010', '#2e0018', '#3e0020'],
    accentColor: '#FF4B7A',
    uiElements: ['Profile Stack', 'Prompts', 'Likes', 'Messages'],
    github: '',
    demo: '',
    tech: ['React Native', 'Firebase', 'Node.js', 'Expo'],
    highlights: [
      'Prompt-based profile cards with like and comment flow',
      'Smart match queue with compatibility scoring',
      'Push notification system for match and message events',
    ],
    screenGradient: 'linear-gradient(160deg, #1a0010 0%, #3e0028 50%, #FF4B7A 100%)',
  },
];
