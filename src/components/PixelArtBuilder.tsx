...
const frontendProjects = [
  {
    ...
    description: 'Responsive frontend for food delivery and tracking with real-time map visualization.',
    tech: ['React', 'Tailwind CSS', 'Leaflet', 'REST APIs'],
    highlights: [
      'Live API-driven map with delivery cluster visualization',
      'Fully responsive with mobile-first layout patterns',
      'Offline-first design with optimistic UI updates',
    ],
    // Unique CSS gradient as the "screenshot" behind tiles
    gradient: 'linear-gradient(135deg, #1a2a1a 0%, #113322 30%, #0a4020 60%, #D4A030 100%)',
    accentColor: '#4ADE80',
    terminalTitle: 'food-khoj.vercel.app',
  },
  {
    name: 'TuneMate UI',
    date: 'Nov–Dec 2024',
    ...
    highlights: [
      'Swipeable match cards using drag gesture detection',
      'Real-time chat with message seen indicators',
      'Spotify player integration with waveform visualizer',
    ],
    gradient: 'linear-gradient(135deg, #1a0a2e 0%, #2d1060 40%, #4a0080 70%, #1DB954 100%)',
    accentColor: '#A855F7',
    terminalTitle: 'music-match-bay.vercel.app',
  },
  {
    ...
    description: 'Event management dashboard with real-time booking analytics and payment flow.',
    tech: ['Next.js', 'Tailwind CSS', 'DodoPayments', 'Chart.js'],
    highlights: [
      'Event dashboard with booking conversion analytics',
      'Animated chart components with live data refresh',
      'Payment flow with step-wise progress indicators',
    ],
    gradient: 'linear-gradient(135deg, #0a0a1a 0%, #1a1a40 40%, #2a2060 70%, #D4A030 100%)',
    accentColor: '#D4A030',
    terminalTitle: 'upsosh.app',
  },
];
