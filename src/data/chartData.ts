...
export const CHART_DATASETS: ChartDataset[] = [
  ...
  },
  {
    ...
    project: {
      ...
      date: 'April 2026',
      github: 'https://github.com/ParrvLuthra22/Netflix_Analysis',
      demo: 'https://public.tableau.com/app/profile/parrv.luthra/viz/NetflixAnalysis_17773211837080/Netflix?showOnboarding=true',
      description: 'Analysis of Netflix Movies and TV Shows according to the years(2008-2020).',
      tech: [],
      highlights: [],
    },
  },
  {
    type: 'radial',
    pillLabel: 'Uber Data Analysis',
    color: 'rgba(255,255,255,0.2)',
    accentColor: 'rgba(255,255,255,0.15)',
    gradient: ['#0d0d0d', '#111111'],
    points: [
      { label: 'Dashboard', value: 30, raw: '—' },
      { label: 'KPIs', value: 40, raw: '—' },
      { label: 'Analysis', value: 20, raw: '—' },
      { label: 'StoryTelling', value: 10, raw: '—' },
    ],
    project: {
      name: 'Uber Data Analysis',
      date: 'Apr 2026',
      github: 'https://github.com/ParrvLuthra22/UberDataAnalysis',
      demo: 'https://public.tableau.com/app/profile/parrv.luthra/viz/UberDataAnalysis_17773725458420/Dashboard1?publish=yes',
